    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("income_id", models.CharField(default=9877764, max_length=14)),
                ("created_at", models.DateField(blank=True)),
                ("income_type", models.CharField(max_length=50)),
                ("income_customer", models.CharField(blank=True, max_length=50)),
                ("income_product", models.CharField(blank=True, max_length=50)),
